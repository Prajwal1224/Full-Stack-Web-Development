    ...
    <div class="container" style="width: 100%;">
				<div class="row justify-content-center">
					<div class="col text-center">
                        ...
                        <a href="index.php" style="color: #ffffff; font-family: 'Sora', sans-serif; font-size: 50px; text-decoration: none;"> JOB PORTAL </a> 
                        </h2>
                    </div>	
                ...
                <div class="row mt-5">
					<div class="col-md-12 text-center">
						<p class="copyrigt">
                        <a style="color: #9FA4A9; text-decoration: none;"> All rights reserved 2024 | Developped by </a> 
                        <a href="https://www.linkedin.com/in/rakshixh" style="color: #FDFFAC;">TE</a> 
                        <a style="color: #FDFFAC; text-decoration: none;">&</a> 
                        <a href="https://www.linkedin.com/in/raksha-b-kottari-421b95220" style="color: #FDFFAC;">Computer</a> 
					    </p>
					</div>
				</div>
    </div>
